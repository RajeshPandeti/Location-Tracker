...
function openInBrowser() {
  ...
  try {
    ...
    if (popup) {
      setStatus("Opened this invite in a new browser tab. If nothing happened, use your browser's menu to open it externally.", "good");
      return;
    }
  } catch (error) {
    console.warn("Could not open browser window", error);
  }
  ...
  setStatus("Use your browser's menu to open this link externally, or copy it from the address bar.", "bad");
}
